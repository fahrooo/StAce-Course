    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Add Student</h4>
                    </div>
                </div>
                <div class="form-create">
                    <form class="create-subject mt-4" action="<?= base_url('admin/addstudent'); ?>" method="post">
                    <div class="clearfix">
                            <div class="pull-left">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input class="form-control date-picker" name="tgl_lahir" placeholder="Select Date" type="text" value="<?= old('tgl_lahir'); ?>">
                                <!-- Error -->
                                <?php if (!empty(session()->getFlashdata('error'))) : ?>
                                    <label style=" color: red;">
