        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-create">
                    <form class="create-subject mt-4" action="<?= base_url('admin/addteacher'); ?>" method="post">
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label" style="font-size: 17px;">Kode Pengajar</label>
                            <div class="col-sm-12 col-md-2">
                                <input class="form-control" type="text" name="id_pengajar" value="<?= $max['id_pengajar'] + 1 ?>" readonly>
                                <!-- Error -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input class="form-control" type="text" name="nama_pengajar" value="<?= old('nama_pengajar'); ?>">
                                <!-- Error -->
                                <?php if (!empty(session()->getFlashdata('error'))) : ?>
                                    <label style="color: red;">
