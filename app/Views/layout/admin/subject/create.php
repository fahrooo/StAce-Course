        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-create mt-4">
                    <?= form_open_multipart(base_url('admin/addsubject')); ?>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label" style="font-size: 17px;">Kode Course</label>
                        <div class="col-sm-12 col-md-2">
                            <input class="form-control" type="text" name="kode_mapel" value="<?= $max['kode_mapel'] + 1 ?>" readonly>
                            <!-- Error -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input class="form-control" type="text" name="harga_course" id="harga" value="<?= old('harga_course'); ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <div class="mb-3">
                                <input type="file" class="form-control" id="foto_course" name="foto_course" value="<?= old('foto_course'); ?>" required>
                            </div>
                            <!-- Error -->
                            <?php if (!empty(session()->getFlashdata('error'))) : ?>
                                <label style="color: red;">
