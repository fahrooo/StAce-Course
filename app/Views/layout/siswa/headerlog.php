                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="<?= base_url('home/home') ?>"><img style="height: 2cm;" src="<?= base_url('assets/img/logo/stace.png') ?>" alt=""></a>
                                </div>
                            </div>
                            <div class="col-xl-10 col-lg-10">
                                <div class="menu-wrapper d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="main-menu d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">
                                                <li class="active"><a href="<?= base_url('home/home') ?>">Home</a></li>
                                                <li><a href="<?= base_url('home/courselog') ?>">Courses</a></li>
                                                <li><a href="<?= base_url('home/aboutuslog') ?>">About</a></li>
                                                <li><a href="<?= base_url('home/contactlog') ?>">Contact</a></li>
                                                <!-- Button -->
                                                <li class="button-header margin-left ">
                                                    <a class="btn"><?= session()->get('nama'); ?></a>
                                                        <ul class="submenu">
